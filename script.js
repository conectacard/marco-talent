const CONFIG = {
    youtubeUrl: "https://www.youtube.com/watch?v=mrmhk74q45Y",
    ...
    get textos() {
        ...
        return {
            cat2: { 
                ...
                c: tObj.cat2_c || "Pasión, técnica y entrega total para llevar el sonido de México a lo más alto." 
            },
            cat3: { 
                t: tObj.cat3_t || "MIS SERVICIOS", 
                c: tObj.cat3_c || "Sesiones de estudio con precisión rítmica para proyectos discográficos y ejecución en vivo de alto nivel para giras y conciertos con agrupaciones y artistas internacionales." 
            }
        };
    }
};
...
function renderGallery(cat) {
    ...
    if (cat === 'cat3') {
        ...
        videoContainer.innerHTML = `
            ...
            <a href="https://www.facebook.com/reel/2891523250917358" target="_blank" style="display: block; width: 100%; box-sizing: border-box; background: #000; color: #fff; padding: 12px 20px; border-radius: 8px; text-decoration: none; font-weight: 800; font-size: 0.85rem; text-align: center; border: 1px solid var(--brand-accent);">${tObj.btn_tributo_tri || 'Experimentan do en Casa'}</a>
            <a href="https://www.facebook.com/reel/2770712399665111" target="_blank" style="display: block; width: 100%; box-sizing: border-box; background: #000; color: #fff; padding: 12px 20px; border-radius: 8px; text-decoration: none; font-weight: 800; font-size: 0.85rem; text-align: center; border: 1px solid var(--brand-accent);">${tObj.btn_junto_mar || 'En el soundcheck'}</a>
            <a href="https://www.facebook.com/reel/3220177708051909" target="_blank" style="display: block; width: 100%; box-sizing: border-box; background: #000; color: #fff; padding: 12px 20px; border-radius: 8px; text-decoration: none; font-weight: 800; font-size: 0.85rem; text-align: center; border: 1px solid var(--brand-accent);">${tObj.btn_con_gente || 'Siempre agradecido'}</a>
        `;
